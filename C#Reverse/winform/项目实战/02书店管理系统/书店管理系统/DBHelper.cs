...
namespace 书店管理系统 {
    public class DBHelper {
        public static string connStr = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Administrator\\Documents\\KKBookShopDb.mdf;Integrated Security=True;Connect Timeout=30";//连接字符串
