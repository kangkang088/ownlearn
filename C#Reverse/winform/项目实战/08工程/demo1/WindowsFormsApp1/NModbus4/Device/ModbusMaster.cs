namespace Modbus.Device
{
    ...
    public abstract class ModbusMaster : ModbusDevice, IModbusMaster
    {
        ...
        public void WriteSingleCoil(byte slaveAddress, ushort coilAddress, bool value)
        {
            ...
            WriteSingleCoilRequestResponse result =  Transport.UnicastMessage<WriteSingleCoilRequestResponse>(request);
        }
        public WriteSingleCoilRequestResponse WriteSingleCoilWithResponse(byte slaveAddress, ushort coilAddress, bool value) {
            var request = new WriteSingleCoilRequestResponse(slaveAddress, coilAddress, value);
            return Transport.UnicastMessage<WriteSingleCoilRequestResponse>(request);
        }
        ...
        public WriteSingleRegisterRequestResponse WriteSingleRegisterWithResponse(byte slaveAddress, ushort registerAddress, ushort value) {
            var request = new WriteSingleRegisterRequestResponse(slaveAddress, registerAddress, value);
            return Transport.UnicastMessage<WriteSingleRegisterRequestResponse>(request);
        }
        ...
        public WriteMultipleRegistersResponse WriteMultipleRegistersWithResponse(byte slaveAddress, ushort startAddress, ushort[] data) {
            ValidateData("data", data, 123);

            var request = new WriteMultipleRegistersRequest(slaveAddress, startAddress, new RegisterCollection(data));
            return Transport.UnicastMessage<WriteMultipleRegistersResponse>(request);
        }
        ...
        public WriteMultipleCoilsResponse WriteMultipleCoilsWithResponse(byte slaveAddress, ushort startAddress, bool[] data) {
            ValidateData("data", data, 1968);

            var request = new WriteMultipleCoilsRequest(slaveAddress, startAddress, new DiscreteCollection(data));
            return Transport.UnicastMessage<WriteMultipleCoilsResponse>(request);
        }
